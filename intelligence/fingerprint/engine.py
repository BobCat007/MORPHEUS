...
class FingerprintEngine:
    ...
    def process(self, session: ReconstructedSession) -> AttackerFingerprint:
    ...
    def _generate_id(self, session: ReconstructedSession) -> str:
    ...
    def get_all(self) -> Dict[str, AttackerFingerprint]:
